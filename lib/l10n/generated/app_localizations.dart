...
abstract class AppLocalizations {
  ...
  /// No description provided for @newScheduledJobButton.
  ///
  /// In en, this message translates to:
  /// **'New Scheduled Job'**
  String get newScheduledJobButton;

  /// No description provided for @newScheduledJobTitle.
  ///
  /// In en, this message translates to:
  /// **'New Scheduled Job'**
  String get newScheduledJobTitle;

  /// No description provided for @afterMinutes.
  ///
  /// In en, this message translates to:
  /// **'After minutes'**
  String get afterMinutes;
  ...
  /// No description provided for @positiveMinutesRequired.
  ///
  /// In en, this message translates to:
  /// **'Enter a positive number of minutes'**
  String get positiveMinutesRequired;
  ...
  /// No description provided for @afterMinutesLabel.
  ///
  /// In en, this message translates to:
